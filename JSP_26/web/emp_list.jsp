...
<head>
    ...
    <script>
        ...
        function search(v) {
            ...
            window.location.href= href="${pageContext.request.contextPath}/emp?cmd=list&did="+v;
        }
    </script>
</head>
<body>
            ...
            <div class="row">
                <div id="tabs" class="list-group col-md-1 ">
                    <c:forEach items="${depts}" var="d">
                        <a tab="tab-item1" onclick="search('${d.did}')" href="${pageContext.request.contextPath}/emp?cmd=list&did=${d.did}" class="tab list-group-item">${d.dname}</a>
                    </c:forEach>
                </div>
                <div class="col-md-11 ">
                    <!--id与上面标签里面的tab一致-->
