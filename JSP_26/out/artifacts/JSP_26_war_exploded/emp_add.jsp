...
<div class="container">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/emp?cmd=add">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-4">
                        <a href="${pageContext.request.contextPath}/emp?cmd=list" class="btn btn-default">取消</a>
                    </div>
                    <div class="col-sm-3">
